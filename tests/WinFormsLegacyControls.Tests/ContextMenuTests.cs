...
namespace System.Windows.Forms.Tests
{
    public class ContextMenuTests
    {
        ...
        [WinFormsTheory]
        [InlineData((int)/*User32.WindowMessage*/PInvoke.WM_KEYDOWN)]
        [InlineData((int)/*User32.WindowMessage*/PInvoke.WM_SYSKEYDOWN)]
        public void ContextMenu_SourceControl_GetProcessingKeyMessage_Success(int windowMessage)
        {
            ...
            */
            ...
            msg.WParam = (nint)Keys.F1;
            new MenuShortcutProcessMessageFilter().PreFilterMessage(ref msg);
        ...
        public void ContextMenu_RightToLeft_SetWithSourceControl_GetReturnsExpected(RightToLeft value, RightToLeft expected)
        {
            ...
            var msg = new Message
            {
                Msg = (int)/*User32.WindowMessage*/PInvoke.WM_KEYDOWN
            };
            //control.PreProcessMessage(ref msg);
            msg.HWnd = control.Handle;
            msg.WParam = (nint)Keys.F1;
