...
namespace System.Windows.Forms.Tests
{
    public class MenuItemTests
    {
        ...
        public static IEnumerable<object[]> IsParent_TestData()
        {
            ...
            nonMdiForm.SetMenu(new MainMenu());
            yield return new object[] { new MenuItem { MdiList = true }, nonMdiForm.GetMenu(), true };

            var formWithNoMdiChildren = new Form(); // { Menu = new MainMenu() };
            formWithNoMdiChildren.SetMenu(new MainMenu());
            formWithNoMdiChildren.Controls.Add(new MdiClient());
            yield return new object[] { new MenuItem { MdiList = true }, formWithNoMdiChildren.GetMenu(), true };

            var formWithMdiChildren = new Form(); // { Menu = new MainMenu() };
            formWithMdiChildren.SetMenu(new MainMenu());
            ...
            yield return new object[] { new MenuItem { MdiList = true }, formWithMdiChildren.GetMenu(), true };
        }
        ...
        public void MenuItem_IsParent_MdiSeparator_ReturnsFalse()
        {
            ...
            parentForm.SetMenu(new MainMenu());
            ...
            parentForm.GetMenu().MenuItems.Add(parentMenuItem);
        ...
        {
            string moreWindows = SR.MDIMenuMoreWindows;

            var formWithNoMdiChildren = new Form(); // { Menu = new MainMenu() };
            formWithNoMdiChildren.SetMenu(new MainMenu());
            formWithNoMdiChildren.Controls.Add(new MdiClient());
            yield return new object[] { new SubMenuItem("text", new MenuItem[] { new MenuItem("child") }) { MdiList = true }, new MainMenu(), new string[] { "child" } };
            yield return new object[] { new SubMenuItem("text") { MdiList = true }, formWithNoMdiChildren.GetMenu(), Array.Empty<string>() };

            var formWithNoVisibleMdiChildren = new Form(); // { Menu = new MainMenu() };
            formWithNoVisibleMdiChildren.SetMenu(new MainMenu());
            ...
            yield return new object[] { new SubMenuItem("text", new MenuItem[] { new MenuItem("child") }) { MdiList = true }, formWithNoVisibleMdiChildren.GetMenu(), new string[] { "child", "-" } };
            yield return new object[] { new SubMenuItem("text"), formWithNoVisibleMdiChildren.GetMenu(), Array.Empty<string>() };
            ...
            yield return new object[] { new SubMenuItem("text", new MenuItem[] { new MenuItem("child") }) { MdiList = true }, formWithMdiChildren.GetMenu(), new string[] { "child", "-", "&1 Form", "&2 Form" } };

            var formWithManyMdiChildren = new Form { /*Menu = new MainMenu(),*/ Visible = true };
            formWithManyMdiChildren.SetMenu(new MainMenu());
            ...
            yield return new object[] { new SubMenuItem("text", new MenuItem[] { new MenuItem("child") }) { MdiList = true }, formWithManyMdiChildren.GetMenu(), new string[] { "child", "-", "&1 Form1", "&2 Form1", "&3 Form2", "&4 Form2", "&5 Form3", "&6 Form3", "&7 Form4", "&8 Form4", "&9 Form10", "&10 Form10", /*"&More Windows..."*/moreWindows } };

            var formWithActiveMdiChildren = new SubForm { /*Menu = new MainMenu(),*/ Visible = true };
            formWithActiveMdiChildren.SetMenu(new MainMenu());
            ...
            yield return new object[] { new SubMenuItem("text", new MenuItem[] { new MenuItem("child") }) { MdiList = true }, formWithActiveMdiChildren.GetMenu(), new string[] { "child", "-", "&1 Form2", "&2 Form1", "&3 Form1", "&4 Form2" } };

            var formWithActiveManyMdiChildren = new SubForm { /*Menu = new MainMenu(),*/ Visible = true };
            formWithActiveManyMdiChildren.SetMenu(new MainMenu());
            ...
            yield return new object[] { new SubMenuItem("text", new MenuItem[] { new MenuItem("child") }) { MdiList = true }, formWithActiveManyMdiChildren.GetMenu(), new string[] { "child", "-", "&1 Form11", "&2 Form1", "&3 Form1", "&4 Form2", "&5 Form2", "&6 Form3", "&7 Form3", "&8 Form4", "&9 Form4", "&10 Form11", /*"&More Windows..."*/moreWindows } };
        }
        ...
        public void MenuItem_PerformClick_MdiSeparator_Nop()
        {
            ...
            parentFormClient.Controls.Add(new Form { MdiParent = parentForm });
            var menuItem = new SubMenuItem("text", new MenuItem[] { new MenuItem() }) { MdiList = true };
            parentForm.GetMenu().MenuItems.Add(menuItem);
            menuItem.OnPopup(null);
        ...
        public void MenuItem_ToString_Invoke_ReturnsExpected(string text)
        {
            ...
            Assert.Equal("WinFormsLegacyControls.MenuItem, Items.Count: 0, Text: " + text, menuItem.ToString());
        }
        ...
        private class SubMenu : Menu
        {
            ...
            internal override bool RenderIsRightToLeft => false;
        }
