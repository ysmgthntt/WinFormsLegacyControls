...
namespace System.Windows.Forms.Tests
{
    ...
    public class StatusBarPanelTests : IClassFixture<ThreadExceptionFixture>
    {
        ...
        public void StatusBarPanel_Icon_GetIcon_Success()
        {
            ...
            Assert.NotEqual(IntPtr.Zero, PInvoke.SendMessage(parent, PInvoke.SB_GETICON, 0));
            Assert.Equal(IntPtr.Zero, PInvoke.SendMessage(parent, PInvoke.SB_GETICON, 1));
            ...
            Assert.NotEqual(IntPtr.Zero, PInvoke.SendMessage(parent, PInvoke.SB_GETICON, 0));
            Assert.NotEqual(IntPtr.Zero, PInvoke.SendMessage(parent, PInvoke.SB_GETICON, 1));
